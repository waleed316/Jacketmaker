        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4 text-center">
                    <span class="badge badge-pill badge-no">1</span><h6 class="bdge-heading">SHIPPING DETAILS</h6>
                </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class="row d-flex justify-content-center">
                <div class="col-xl-8 ">
                    <h6 class="billing-add mt-5 mb-5">SHIPPING DETAILS</h6>
                    <form action="">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-height mmm"  placeholder="Mobile # eg (+92-1234567)">
                            </div>
                            <div class="col-sm-6">
                                <input type="email" class="form-control form-control-height"  placeholder="Email">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-height mmm"  placeholder="City">
                            </div>
                            <div class="col-sm-6">
                                <select class="form-control">
                        ...
                        <div class="form-group row mt-5">
                            <div class="col-sm-6">
                                <a href="cart.php" class="back-btn"><i class="fa fa-angle-left" aria-hidden="true"></i> Back</a>
                            </div>
                            <div class="col-sm-6 text-right">
                                <a href="check-next.php" class="next-check-btn btn">Next</a>
                            </div>
                        </div>

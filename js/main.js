    ...
    a.fn.coverflow = function (c) {
        ...
        return this.loadController = function () {
            ...
            T = a(".Controller").avController({
                path: G.path
            }), $preloader = a(".Preloader"), $preloader.css("display", "none"), H.pauseDelay = 1e3 * parseInt($preloader.css("transition-duration"));
            var e = !0,
                h = !1;
            T.on("prev", function () {
                f(i - 1)
...
(function ( $ ) {
        ...
        $.fn.bootstrapNumber = function( options ) {
            ...
            return this.each(function(e) {
                ...
                var down = $("<button type='button'>" + settings.downText + "</button>").attr('class', 'btn btn-minus btn-' + settings.downClass).click(function() {
                    setText(parseInt(clone.val() || clone.attr('value')) - step);
                });
                var up = $("<button type='button'>" + settings.upText + "</button>").attr('class', 'btn btn-minus btn-' + settings.upClass).click(function() {
                    setText(parseInt(clone.val() || clone.attr('value')) + step);
                });
                $("<span class='input-group-btn btn-span'></span>").append(down).appendTo(group);

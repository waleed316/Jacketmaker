            ...
            <!-- <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-4">
                        <div class="image-box">
                            <img src="images/7393484-1-black.jpg" class="img-fluid" alt="">
...
<div class="container-fluid footer-last">
    <div class="row">
        <div class="col-xl-12">
            <h6 class="text-center footer-tagline">&copy; Copyright abcd MakeYourJacket Ltd. All rights Reserved.</h6>
        </div>
    </div>
</div>
